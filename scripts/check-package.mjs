...
try {
  ...
  const requiredPackedPaths = [
    ...
    "third_party_source/sidereon-core-0.36.1/tides/mod.rs",
    "third_party_source/sidereon-core-0.36.1/tides/ocean.rs",
    "third_party_source/sidereon-core-0.36.1/tides/pole.rs",
    "pkg/sidereon.js",
    "pkg/sidereon.d.ts",
